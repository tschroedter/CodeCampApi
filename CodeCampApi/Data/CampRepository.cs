...
namespace CodeCampApi.Data
{
    public class CampRepository : ICampRepository
    {
        ...
        public async Task < Talk [ ] > GetTalksByMonikerAsync ( string moniker ,
        ...
        public async Task < Talk > GetTalkByMonikerAsync ( string moniker ,
                                                           int talkId ,
                                                           bool includeSpeakers = false )
        {
            _logger.LogInformation ( "Getting all Talks for a Camp" ) ;
